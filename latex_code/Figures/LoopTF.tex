...
\draw[thick] (2.45,-1.6) rectangle (3.95,-2.4);
\draw node at (3.2,-2){$H_{fb}$};

\draw node at (-1.2,0.25){$\hat{v}_{ref}[n]$};
\draw node at (6.4,0.25){$\hat{v}_o[n]$};
\draw node at (0.7,0.25){$\hat{e}[n]$};


\draw[thin,dashed] (3.0,-0.7) -- (3.0,0.7);
\draw[thin,dashed] (3.6,-0.7) -- (3.6,0.7);

\draw node at (3.8,0.9){$\hat{u}_x[n]$};
\draw node at (2.8,0.9){$\hat{u}_y[n]$};
