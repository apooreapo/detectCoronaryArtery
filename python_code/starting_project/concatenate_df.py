...
file_titles = "./extracted_features/final/last/*.csv"
files = glob.glob(file_titles)
file_titles_no_cad = "./extracted_features/final/last/final_extracted_1*.csv"
files_no_cad = glob.glob(file_titles_no_cad)
file_titles_cad = "./extracted_features/final/last/final_extracted_s*.csv"
...
output = "./extracted_features/final/last/" + "last_cad.csv"
...
output = "./extracted_features/final/last/" + "last_no_cad.csv"
...
output = "./extracted_features/final/last/" + "last_full.csv"
